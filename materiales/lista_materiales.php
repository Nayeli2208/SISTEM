...
<head>
    ...
    <title>Lista </title>
    <!-- lista de link con librerias enlaces-->
    ...
    <main class="full-box main-container">
        <section class="full-box nav-lateral">
            ...
            <div class="full-box nav-lateral-content">
                ...
                <nav class="full-box nav-lateral-menu"><!--inicio de barra de navegacion-->
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="agrega_material.html"><i class="fas fa-plus fa-fw"></i> &nbsp; Agregar </a>
                                </li>
                                <li>
                ...
                </nav><!--terminacion de barra de navegacion-->
            </div>
        </section>

        <section class="full-box page-content"><!--se inicia un anueva seccion-->
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    ...
                    <li>
                        <a class="active" href="lista_materiales.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp;
                            LISTA</a>
                    </li>
                    <li>
                        <a href="busca_materiales_a.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR</a>
                    </li>
                </ul>
            </div>
            <h6 class="text-left">
        ...
        </section><!--se termina la seccion-->
    </main>
<!--Ingreso a librerias o link de uso-->
