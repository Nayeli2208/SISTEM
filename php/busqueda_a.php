...
<body>
	...
	<main class="full-box main-container">
		...
		<section class="full-box nav-lateral">
			...
			<div class="full-box nav-lateral-content">
				<figure class="full-box nav-lateral-avatar">
					<figcaption class="roboto-medium text-center">Paramédicos<br><small class="roboto-condensed-light">Usuario</small>
					</figcaption>
				</figure>
		...
		<section class="full-box page-content">
			...
			<!-- Contenido de página -->
			<div class="container-fluid">
				<form class="form-neon" action="busqueda_a.php" method="post">
				<div class="container-fluid">
                        <ul class="full-box list-unstyled page-nav-tabs">
                            <li class="nav-item">
						...
						<div class="row justify-content-md-center">
							<div class="col-12 col-md-6">
								<div class="form-group">
									<label for="inputSearch" class="bmd-label-floating">Busqueda A</label>
									...
									<table border="1" class="table table-bordered text-center table-sm"><!--inicio de tabla-->
										...
										<tbody>
											...
											if (isset($_POST['enviar'])) {
												$d = $_POST['d'];
												$condicion = "select * from m_ambulancia where d='$d'";
												$con = new ConexionDB();
											...
											?>
													<tr>
														...
														<td><?php echo $v['c'] ?></td>
														<td><?php echo $v['f'] ?></td>
														<td><?php echo $v['nom_recibe'] ?></td>
														<td><?php echo $v['obs_material'] ?></td>
														<td><a href="actualizar_a.php?d=<?php echo $v['d'] ?>" class="btn btn-success"><i class='fas fa-tools'></i></a>
															<a href="eliminar_a.php?d=<?php echo $v['d'] ?>" class="btn btn-danger"><i class="far fa-trash-alt"></i></a>
														</td>
													</tr>
											<?php }
											} ?>
