...
<body>
    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content"><!--inicio de 2da seccion-->
            ...
            $consulta = "SELECT * FROM m_rescate WHERE d='$d'";
            $lista = $con->consultar($consulta);
            foreach ($lista as $v) {
            ?>

                <form action="update_r.php" method="POST"><!--uso de metodo POST-->
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <input type="date" class="form-control" name="sm" value="<?php echo $v['sm'] ?>">
                            </div>
                            <div class="col-sm-4">
                                <label>Recibe:</label>
                                <input type="text" class="form-control" name="rc" value="<?php echo $v['rc'] ?>">
                            </div>
                            <div class="col-sm-4">
                                <label>OBSERVACIONES</label>
                                <input type="text" class="form-control" name="ob" value="<?php echo $v['ob'] ?>">
                            </div>
                        </div>
                        <!--fin del formulario-->
                        <br>
                        <p class="text-center" style="margin-top: 40px;">
                            ...
                            <a href="busqueda_r.php" type="button" class="btn btn-outline-danger">Regresar</a><!--boton de accion-->
                        </p>
                    </div>
                <?php } ?>
                </form>
