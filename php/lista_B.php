...
<body>
    ...
    <main class="full-box main-container">
                ...
                <nav class="full-box nav-lateral-menu"><!--inicio de barra de navegacion-->
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="../php/lista_materiales.php"><i class="fas fa-plus fa-fw"></i> &nbsp; Agregar </a>
                                </li>
                                <li>
                                    <a href="../php/lista_A.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp;
                                        Lista</a>
                                </li>
                                <li>
        ...
        <section class="full-box page-content">
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    ...
                    <li>
                        <a class="active" href="../materiales/lista_materiales.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA</a>
                    </li>
                    <li>
                        ...
                        <table border="1" class="table table-bordered text-center table-sm" id="tabla"><!--inicio de tabla-->
                            <thead>
                                ...
                                while ($fila = mysqli_fetch_assoc($resultado)) {
                                    ...
                                    echo "<td>" . $fila['c'] . "</td>";
                                    echo "<td>" . $fila['f'] . "</td>";
                                    echo "<td>" . $fila['nom_recibe'] . "</td>";
                                    echo "<td>" . $fila['obs_material'] . "</td>";
                                    echo "</tr>";
                                }
                                ?>
                            </thead>
        ...
        </section><!--se finalisa la 2da seccion-->
    </main>
